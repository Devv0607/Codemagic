...
class WhiteLabelWidget extends StatefulWidget {
  const WhiteLabelWidget({super.key});

  static String routeName = 'white-label';
  static String routePath = '/whiteLabel';

  @override
  State<WhiteLabelWidget> createState() => _WhiteLabelWidgetState();
}
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: ClipRRect(
                      ...
                      child: SvgPicture.asset(
                        'assets/images/flutter-flow.svg',
                        width: 108.0,
                        height: 59.6,
                        fit: BoxFit.cover,
                      ),
                  ...
                  Padding(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(8.0),
                      child: Image.asset(
                        'assets/images/Screenshot_(159).png',
                        width: 381.2,
                        height: 199.09,
                        fit: BoxFit.cover,
                      ),
                  ...
                  Column(
                    ...
                    children: [
                      ClipRRect(
                        borderRadius: BorderRadius.circular(8.0),
                        child: Image.asset(
                          'assets/images/Screenshot_(160).png',
                          width: 363.73,
                          height: 200.0,
                          fit: BoxFit.cover,
                        ),
                  ...
                  Padding(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(8.0),
                      child: Image.asset(
                        'assets/images/Screenshot_(161).png',
                        width: 367.5,
                        height: 200.0,
                        fit: BoxFit.cover,
                      ),
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(8.0),
                        child: Image.asset(
                          'assets/images/Screenshot_(162).png',
                          width: 266.39,
                          height: 200.0,
                          fit: BoxFit.cover,
                        ),
                  ...
                  ClipRRect(
                    borderRadius: BorderRadius.circular(8.0),
                    child: Image.asset(
                      'assets/images/Screenshot_(163).png',
                      width: 300.01,
                      height: 200.0,
                      fit: BoxFit.cover,
                    ),
                          ...
                          child: RichText(
                            ...
                            text: TextSpan(
                              children: [
                                TextSpan(
                                  text:
                                      'Automate the code signing of your white-label apps. For iOS apps, Codemagic has an integration with Apple Developer Portal. Certificates and provisioning profiles can be automatically created, fetched, and updated from the Apple Developer Portal to code-',
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        font: GoogleFonts.ubuntu(
                  ...
                  ClipRRect(
                    borderRadius: BorderRadius.circular(8.0),
                    child: Image.asset(
                      'assets/images/Screenshot_(164).png',
                      width: 239.1,
                      height: 200.0,
                      fit: BoxFit.cover,
                    ),
                  ...
                  ClipRRect(
                    borderRadius: BorderRadius.circular(8.0),
                    child: Image.asset(
                      'assets/images/Screenshot_(165).png',
                      width: 311.9,
                      height: 200.0,
                      fit: BoxFit.cover,
                    ),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Align(
                              ...
                              child: Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    30.0, 0.0, 30.0, 0.0),
                                child: Text(
                                  'You can use fast macOS and Linux machines. macOS M2 is now available, and Linux instances can scale up to as many vCPU and RAM as required.\n',
                            ...
                            ClipRRect(
                              borderRadius: BorderRadius.circular(8.0),
                              child: Image.asset(
                                'assets/images/Screenshot_(166).png',
                                width: 567.9,
                                height: 107.27,
                                fit: BoxFit.cover,
                              ),
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          gradient: LinearGradient(
                            colors: [Color(0xFFEF9439), Color(0xFFFF02CC)],
                            stops: [0.0, 1.0],
                            begin: AlignmentDirectional(-1.0, 0.87),
                            end: AlignmentDirectional(1.0, -0.87),
                          ),
                  ...
                  ClipRRect(
                    borderRadius: BorderRadius.circular(8.0),
                    child: Image.asset(
                      'assets/images/Screenshot_(167).png',
                      width: 448.8,
                      height: 228.49,
                      fit: BoxFit.cover,
                    ),
                          ...
                          Align(
                            ...
                            child: Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  30.0, 0.0, 30.0, 0.0),
                              child: Text(
                                'Sign up today and deliver your apps in\nrecord time',
                                textAlign: TextAlign.center,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
