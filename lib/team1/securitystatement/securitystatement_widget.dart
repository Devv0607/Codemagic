...
import 'securitystatement_model.dart';
export 'securitystatement_model.dart';

class SecuritystatementWidget extends StatefulWidget {
  const SecuritystatementWidget({super.key});

  static String routeName = 'securitystatement';
  static String routePath = '/securitystatement';

  @override
  State<SecuritystatementWidget> createState() =>
      _SecuritystatementWidgetState();
}

class _SecuritystatementWidgetState extends State<SecuritystatementWidget> {
  late SecuritystatementModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SecuritystatementModel());
  }
              ...
              Column(
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(0.0, 40.0, 30.0, 0.0),
                      child: Text(
                      ...
                      child: RichText(
                        ...
                        text: TextSpan(
                          children: [
                            TextSpan(
                              text:
                                  'Security is one of the top priorities for almost all organizations. Any security breach can cause huge damage to the business, including loss of trust, reputation, or in the worst case, loss of the entire business. In this post, we will describe some of the security features of ',
                            ...
                            TextSpan(
                              text: ' Codemagic ',
                              style: TextStyle(
                                color: Color(0xFF1E07F4),
                              ),
                            ),
                            TextSpan(
                              text:
                                  'CI/CD to give you a better understanding of how we ensure the security of your source code and sensitive information.',
                              style: TextStyle(
                                color: Colors.black,
                              ),
                            )
                                ...
                                child: RichText(
                                  ...
                                  text: TextSpan(
                                    children: [
                                      TextSpan(
                                        text:
                                            'CHANGE MANAGEMENT AFFECTING END \nUSERS',
                                        style: TextStyle(
                                          color: Color(0xFF0D0D0D),
                                        ),
                                      )
                        ...
                        Align(
                          ...
                          child: Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 10.0, 0.0, 0.0),
                            child: Text(
                              'We have build logs available for customers in Codemagic web app.\nProduct usage is tracked anonymously for analytics.\nSystem logs are used internally, which have information about internal services without user data.\nWe have an audit in case user requests to remove data. We do not review it regularly build logs are retained along with build history and are available 6 months by default.',
                              textAlign: TextAlign.justify,
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                              ...
                              child: Padding(
                                ...
                                child: RichText(
                                  ...
                                  text: TextSpan(
                                    children: [
                                      TextSpan(
                                        text: 'INFORMATION SECURITY RESOURCES',
                                        style: TextStyle(
                                          color: Color(0xFF0D0D0D),
                                        ),
                                      )
                              ...
                              child: Padding(
                                ...
                                child: RichText(
                                  ...
                                  text: TextSpan(
                                    children: [
                                      TextSpan(
                                        text: 'REPORTING SECURITY INCIDENTS',
                                        style: TextStyle(
                                          color: Color(0xFF0D0D0D),
                                        ),
                                      )
